...
def test_add_attributes(attr_container: DataContainer):
    ...
    attrs = {"str_attr": "test_string", "int_attr": 42, "float_attr": 3.14, "list_attr": [1, 2, 3]}
...
def test_get_attributes(attr_container: DataContainer):
    ...
    attrs = {"str_attr": "test_string", "int_attr": 42, "float_attr": 3.14}
    attr_container.add_attributes("/testgroup", **attrs)
...
@pytest.mark.parametrize(
    "path, key, initial_value, update_value",
    [
...
def test_update_attribute(attr_container: DataContainer, path: str, key: str, initial_value: Any, update_value: Any):
    # Add initial attribute
    attr_container.add_attribute(path, key, initial_value)
...
def test_update_attributes(attr_container: DataContainer):
    ...
    initial_attrs = {"str_attr": "initial", "int_attr": 42, "float_attr": 3.14}
    attr_container.add_attributes("/testgroup", **initial_attrs)

    # Update attributes
    updated_attrs = {"str_attr": "updated", "int_attr": 100, "float_attr": 2.718}
...
def test_missing_unit(attr_container: DataContainer):
